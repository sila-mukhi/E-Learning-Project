  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate('/listTestimonial'); // Redirect to the list after successful update
      } else {
  ...
  return (
    <div className="edit4">
      ...
      <form className="flex-col" onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <div className="edit4-product-name flex-col">
          <p>Change Image</p>
        ...
        <div className="edit4-product-name flex-col">
          <p>Profession</p>
          <input type="text" name="profession" value={testimonial.profession} onChange={handleInputChange} required />
        </div>
        <div className="edit4-product-name flex-col">
          <p>Message</p>
          <input type="text" name="message" value={testimonial.message} onChange={handleInputChange} required />
        </div>
        <button type="submit" className='update-btn4'>Update Testimonial</button>
      </form>
    </div>
  );
};
